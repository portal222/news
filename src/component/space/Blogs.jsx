...
const Blogs = () => {
    ...
    const getSpace = async (page) => {
        const url = `https://api.spaceflightnewsapi.net/v4/blogs/?limit=10&offset=${page}0`
        ...
        <>
            <div className="news">
                ...
                <div className="holdSelect">
                    <p className="spaceFont"> SPACE <br></br> BLOGS </p>
                    <h4> {total} results for blogs page {page}</h4>
                </div>
